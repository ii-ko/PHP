...
<div class="wrapper">
	<div class="row">
		<div class="col-md-6">
    		<a href="#"><img src="{{ url ('/images/fireman-100722_1280-800x445.jpg') }}" width="100%" /></a>
            <span class="caption">Lorem ipsum dolor sit amet</span>
    	</div>
    	<div class="col-md-6">
    		<div class="row">
        		<div class="col-md-6">
        	    	<a href="#"><img src="{{ url ('/images/bride-301814_1280-392x272.jpg') }} " width="100%" height="162" /></a>
		            <span class="caption">Lorem ipsum dolor sit amet</span>
        	    </div>
        	    <div class="col-md-6">
        	    	<a href="#"><img src="{{ url ('/images/sea-418742_1920-392x272.jpg') }} " width="100%" height="162" /></a>
		            <span class="caption">Lorem ipsum dolor sit amet</span>
        	    </div>
        	</div>
        	<div class="row" style="margin-top:30px;">
        		<div class="col-md-6">
        	    	<a href="#"><img src="{{ url ('/images/kayaking-569282_1280-392x272.jpg') }} " width="100%" height="162" /></a>
		            <span class="caption">Lorem ipsum dolor sit amet</span>
        	    </div>
        	    <div class="col-md-6">
        	    	<a href="#"><img src="{{ url ('/images/clouds-sky-stadium-4516-392x272.jpg') }} " width="100%" height="162" /></a>
                    <span class="caption">Lorem ipsum dolor sit amet</span>
        	    </div>
        	</div>        
    	</div>
        ...
        <div class="col-md-12" style="border:1px solid #ccc; padding:15px 15px 30px 0px;">
            ...
            <div class="col-md-6">
            	<div class="row" style="border-bottom:1px solid #ccc; padding-bottom:10px; margin-bottom:10px;">
	            	<div class="col-md-4">
                    	<div class="row">
    	            		<img src="{{ url ('/images/mosquito-542156_1280-392x272.jpg') }} " width="100%" />
        	        	</div>
                    </div>
            	    <div class="col-md-8">
                    	<div class="row">
                ...
                <div class="row" style="border-bottom:1px solid #ccc; padding-bottom:10px; margin-bottom:10px;">
	            	<div class="col-md-4">
                    	<div class="row">
    	            		<img src="{{ url ('/images/solar-eclipse-152834_1280-392x272.png') }}" width="100%" />
        	        	</div>
                    </div>
            	    <div class="col-md-8">
                    	<div class="row">
                ...
                <div class="row" style="border-bottom:1px solid #ccc; padding-bottom:10px; margin-bottom:10px;">
	            	<div class="col-md-4">
                    	<div class="row">
    	            		<img src="{{ url ('/images/yummy-333666_1280-392x272.jpg') }} " width="100%" />
        	        	</div>
                    </div>
            	    <div class="col-md-8">
                    	<div class="row">
                ...
                <div class="row" style="border-bottom:1px solid #ccc; padding-bottom:10px; margin-bottom:10px;">
	            	<div class="col-md-4">
                    	<div class="row">
    	            		<img src="{{ url ('/images/relay-race-655353_1280-390x205.jpg') }} " width="100%" />
        	        	</div>
                    </div>
            	    <div class="col-md-8">
                    	<div class="row">
